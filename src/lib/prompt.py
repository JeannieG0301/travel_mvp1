...
- **标题**：简洁明了，如「新西兰南岛 7 日自驾行程」，不含冗余修饰。
- **总览 plan**：1～2 段概括整体路线、风格与节奏，让用户一眼看懂行程骨架。
- **按天逻辑**：每天有清晰主题（如「奥克兰落地—市区」「皇后镇—瓦纳卡」），上午/下午/晚上衔接自然。
- **交通**：必须写清「从哪到哪、约多久」，例如「奥克兰机场→市区租车点（约 20 分钟）」；避免笼统表述。
- **景点与活动**：写具体名称与可执行动作（如「天空塔观景」「使命湾散步」），不写「游览」「参观」等空泛词。
- **住宿**：写区域或类型（如「皇后镇湖畔酒店」「市中心或海滨区域」），便于用户预订。
- 全文用语简洁、分段清晰，便于扫读与导出分享。
